...
const Ca = "ar-SA", ka = "مرحبًا، اسمي {name} وأنا صوت عربي.", qa = [{ label: "Amina", name: "Microsoft Amina Online (Natural) - Arabic (Algeria)", language: "ar-DZ", gender: "female", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Ismael", name: "Microsoft Ismael Online (Natural) - Arabic (Algeria)", language: "ar-DZ", gender: "male", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Laila", name: "Microsoft Laila Online (Natural) - Arabic (Bahrain)", language: "ar-BH", gender: "female", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Ali", name: "Microsoft Ali Online (Natural) - Arabic (Bahrain)", language: "ar-BH", gender: "male", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Salma", name: "Microsoft Salma Online (Natural) - Arabic (Egypt)", language: "ar-EG", gender: "female", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Shakir", name: "Microsoft Shakir Online (Natural) - Arabic (Egypt)", language: "ar-EG", gender: "male", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Rana", name: "Microsoft Rana Online (Natural) - Arabic (Iraq)", language: "ar-IQ", gender: "female", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Bassel", name: "Microsoft Bassel Online (Natural) - Arabic (Iraq)", language: "ar-IQ", gender: "male", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Sana", name: "Microsoft Sana Online (Natural) - Arabic (Jordan)", language: "ar-JO", gender: "female", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Taim", name: "Microsoft Taim Online (Natural) - Arabic (Jordan)", language: "ar-JO", gender: "male", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Noura", name: "Microsoft Noura Online (Natural) - Arabic (Kuwait)", language: "ar-KW", gender: "female", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Fahed", name: "Microsoft Fahed Online (Natural) - Arabic (Kuwait)", language: "ar-KW", gender: "male", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Layla", name: "Microsoft Layla Online (Natural) - Arabic (Lebanon)", language: "ar-LB", gender: "female", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Rami", name: "Microsoft Rami Online (Natural) - Arabic (Lebanon)", language: "ar-LB", gender: "male", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Iman", name: "Microsoft Iman Online (Natural) - Arabic (Libya)", language: "ar-LY", gender: "female", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Omar", name: "Microsoft Omar Online (Natural) - Arabic (Libya)", language: "ar-LY", gender: "male", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Mouna", name: "Microsoft Mouna Online (Natural) - Arabic (Morocco)", language: "ar-MA", gender: "female", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Jamal", name: "Microsoft Jamal Online (Natural) - Arabic (Morocco)", language: "ar-MA", gender: "male", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Aysha", name: "Microsoft Aysha Online (Natural) - Arabic (Oman)", language: "ar-OM", gender: "female", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Abdullah", name: "Microsoft Abdullah Online (Natural) - Arabic (Oman)", language: "ar-OM", gender: "male", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Amal", name: "Microsoft Amal Online (Natural) - Arabic (Qatar)", language: "ar-QA", gender: "female", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Moaz", name: "Microsoft Moaz Online (Natural) - Arabic (Qatar)", language: "ar-QA", gender: "male", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Zariyah", name: "Microsoft Zariyah Online (Natural) - Arabic (Saudi Arabia)", language: "ar-SA", gender: "female", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Hamed", name: "Microsoft Hamed Online (Natural) - Arabic (Saudi Arabia)", language: "ar-SA", gender: "male", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Amany", name: "Microsoft Amany Online (Natural) - Arabic (Syria)", language: "ar-SY", gender: "female", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Laith", name: "Microsoft Laith Online (Natural) - Arabic (Syria)", language: "ar-SY", gender: "male", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Reem", name: "Microsoft Reem Online (Natural) - Arabic (Tunisia)", language: "ar-TN", gender: "female", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Hedi", name: "Microsoft Hedi Online (Natural) - Arabic (Tunisia)", language: "ar-TN", gender: "male", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Fatima", name: "Microsoft Fatima Online (Natural) - Arabic (United Arab Emirates)", language: "ar-AE", gender: "female", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Hamdan", name: "Microsoft Hamdan Online (Natural) - Arabic (United Arab Emirates)", language: "ar-AE", gender: "male", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Maryam", name: "Microsoft Maryam Online (Natural) - Arabic (Yemen)", language: "ar-YE", gender: "female", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Saleh", name: "Microsoft Saleh Online (Natural) - Arabic (Yemen)", language: "ar-YE", gender: "male", quality: ["veryHigh"], rate: 1, pitchControl: !1, browser: ["Edge"], preloaded: !0 }, { label: "Mariam", name: "Mariam", localizedName: "apple", language: "ar-001", gender: "female", quality: ["low", "normal"], rate: 1, pitch: 1, os: ["macOS", "iOS", "iPadOS"] }, { label: "Apple Laila", name: "Laila", localizedName: "apple", language: "ar-001", gender: "female", quality: ["low", "normal"], rate: 1, pitch: 1, os: ["macOS", "iOS", "iPadOS"] }, { label: "Tarik", name: "Tarik", localizedName: "apple", language: "ar-001", gender: "male", quality: ["low", "normal"], rate: 1, pitch: 1, os: ["macOS", "iOS", "iPadOS"] }, { label: "Majed", name: "Majed", localizedName: "apple", language: "ar-001", gender: "male", quality: ["low", "normal", "high"], rate: 1, pitch: 1, os: ["macOS", "iOS", "iPadOS"], preloaded: !0 }, { label: "Hoda", name: "Microsoft Hoda - Arabic (Arabic )", language: "ar-EG", gender: "female", quality: ["normal"], rate: 1, pitch: 1, os: ["Windows"], preloaded: !0 }, { label: "Naayf", name: "Microsoft Naayf - Arabic (Saudi Arabia)", language: "ar-AS", gender: "male", quality: ["normal"], rate: 1, pitch: 1, os: ["Windows"], preloaded: !0 }, { label: "صوت انثوي 1", name: "Android Speech Recognition and Synthesis from Google ar-xa-x-arc-network", altNames: ["Android Speech Recognition and Synthesis from Google ar-xa-x-arc-local", "Android Speech Recognition and Synthesis from Google ar-language"], nativeID: ["ar-xa-x-arc-network", "ar-xa-x-arc-local"], language: "ar", gender: "female", quality: ["high"], rate: 1, pitch: 1, os: ["Android", "ChromeOS"], preloaded: !0 }, { label: "صوت انثوي 2", name: "Android Speech Recognition and Synthesis from Google ar-xa-x-arz-network", altNames: ["Android Speech Recognition and Synthesis from Google ar-xa-x-arz-local"], nativeID: ["ar-xa-x-arz-network", "ar-xa-x-arz-local"], language: "ar", gender: "female", quality: ["high"], rate: 1, pitch: 1, os: ["Android", "ChromeOS"], preloaded: !0 }, { label: "صوت ذكر 1", name: "Android Speech Recognition and Synthesis from Google ar-xa-x-ard-network", altNames: ["Android Speech Recognition and Synthesis from Google ar-xa-x-ard-local"], nativeID: ["ar-xa-x-ard-network", "ar-xa-x-ard-local"], language: "ar", gender: "male", quality: ["high"], rate: 1, pitch: 1, os: ["Android", "ChromeOS"], preloaded: !0 }, { label: "صوت ذكر 2", name: "Android Speech Recognition and Synthesis from Google ar-xa-x-are-network", altNames: ["Android Speech Recognition and Synthesis from Google ar-xa-x-are-local"], nativeID: ["ar-xa-x-are-network", "ar-xa-x-are-local"], language: "ar", gender: "male", quality: ["high"], rate: 1, pitch: 1, os: ["Android", "ChromeOS"], preloaded: !0 }], xa = {
  ...
  for (const i of t)
    if (i && Be[i]) {
      const o = Be[i], g = ie(a)[0], n = o[a] || o[g];
      if (n) {
  ...
  for (const r of Object.values(Vo))
    if (r.values.some((t) => a.includes(`.${t}.`)))
      return r.quality;
};
class A {
  static instance;
  ...
  inferVoiceQuality(a, r, t) {
    const i = a.voiceURI ? Ko(a.voiceURI) : void 0;
    if (i) return i;
    ...
    if (r?.quality && r.quality.length > 0) {
      const o = Math.min(t - 1, r.quality.length - 1), g = r.quality[o];
      if (g)
        return g;
    }
    return null;
  ...
  removeDuplicate(a) {
    ...
    for (const t of a) {
      ...
      if (!o)
        ...
        this.getQualityValue(t.quality) >= g && r.set(i, t);
      }
    }
  ...
  getLanguages(a, r) {
    ...
    return (r ? this.filterVoices([...this.voices], r) : this.voices).forEach((o) => {
      const g = o.language, [n] = A.extractLangRegionFromBCP47(g), m = n, s = A.getLanguageDisplayName(n, a), f = t.get(m) || { count: 0, label: s, code: n };
      t.set(m, { ...f, count: f.count + 1 });
    }), Array.from(t.entries()).map(([o, { code: g, label: n, count: m }]) => ({
      code: g,
      label: n,
      count: m
  ...
  getRegions(a) {
    ...
    return this.voices.forEach((t) => {
      ...
      try {
        ...
        g = new Intl.DisplayNames([n], { type: "region" }).of(t) || o;
      } catch (n) {
  ...
  parseToReadiumSpeechVoices(a) {
    const r = (o) => {
      ...
      const g = r(o.lang), [n] = A.extractLangRegionFromBCP47(g), m = this.normalizeVoiceName(o.name), s = `${o.lang.toLowerCase()}_${m}`, f = t.get(s) || 1;
      let c = Pe(g);
      (!c || c.length === 0) && (c = Pe(n));
      const u = this.findMatchingJsonVoice(c, m), d = this.inferVoiceQuality(o, u, f);
      return u ? {
        ...u,
        source: "json",
        originalName: o.name,
  ...
  filterVoices(a, r) {
    ...
    if (r.language) {
      ...
      t = t.filter((o) => i.some((g) => {
        const n = g.toLowerCase(), m = o.language?.toLowerCase(), s = o.altLanguage?.toLowerCase();
        if (m === n || s === n)
          return !0;
        const [f] = n.split("-");
    ...
    )), r.excludeNovelty && (t = Ue(t)), r.excludeVeryLowQuality && (t = ze(t)), t;
  }
  /**
  ...
  sortVoices(a, r) {
    ...
    switch (r.by) {
      ...
      case "language":
        t.sort((i, o) => {
          const [g, n] = A.extractLangRegionFromBCP47(i.language), [m, s] = A.extractLangRegionFromBCP47(o.language), f = A.getLanguageDisplayName(g).toLowerCase(), c = A.getLanguageDisplayName(m).toLowerCase();
          if (r.preferredLanguages?.length) {
            const d = r.preferredLanguages.findIndex((O) => {
              const [k, C] = A.extractLangRegionFromBCP47(O);
              return g === k.toLowerCase() && (!C || !n || C === n);
            }), S = r.preferredLanguages.findIndex((O) => {
              const [k, C] = A.extractLangRegionFromBCP47(O);
              return m === k.toLowerCase() && (!C || !s || C === s);
            });
            if (d !== -1 && S !== -1)
              return d === S && n && s ? r.order === "desc" ? s.localeCompare(n) : n.localeCompare(s) : r.order === "desc" ? S - d : d - S;
            if (d !== -1) return -1;
            if (S !== -1) return 1;
          }
      ...
      case "gender":
        t.sort((i, o) => {
          const g = i.gender || "", n = o.gender || "";
          return r.order === "desc" ? n.localeCompare(g) : g.localeCompare(n);
        });
        break;
      case "quality":
        t.sort((i, o) => {
          const g = this.getQualityValue(i.quality), n = this.getQualityValue(o.quality);
          return r.order === "desc" ? n - g : g - n;
        });
        break;
      case "region":
        t.sort((i, o) => {
          const [g, n = ""] = A.extractLangRegionFromBCP47(i.language), [m, s = ""] = A.extractLangRegionFromBCP47(o.language);
          if (r.preferredLanguages?.length) {
            const c = r.preferredLanguages.findIndex((O) => {
              const [k, C] = A.extractLangRegionFromBCP47(O);
              return g === k.toLowerCase() && n === C?.toUpperCase();
          ...
          return f === 0 ? g.localeCompare(m) : f;
        });
        break;
    }
    return t;
...
const Wo = ["webKit", "moz", "ms", "o"], _o = [
  ...
  "resume",
  "start"
], Jo = (e) => `${e.charAt(0).toUpperCase()}${e.slice(1)}`, Z = (e = {}, a) => Object.hasOwnProperty.call(e, a) || a in e || !!e[a], Yo = (e) => typeof window < "u" && e in window, Zo = (e) => {
  const a = Jo(e), r = Wo.map((i) => `${i}${a}`), t = [e, a].concat(r).find(Yo);
...
function al() {
  ...
  function a(t) {
    ...
    function n(s) {
      ...
      if (Array.isArray(s)) return g(s, n);
    ...
    function m(s) {
      if (typeof s != "object" || s === null) return s;
      if (Array.isArray(s)) return g(s, m);
      if (s.constructor !== Object && (o = i.get(s.constructor)))
        return o(s, m);
      const f = {};
      for (const c in s) {
  ...
  function r(t) {
    ...
    if (g.set(Date, (c) => new Date(c)), g.set(Map, (c, u) => new Map(m(Array.from(c), u))), g.set(Set, (c, u) => new Set(m(Array.from(c), u))), t.constructorHandlers)
    ...
    function m(c, u) {
      ...
      for (let O = 0; O < d.length; O++) {
        ...
        if (typeof C != "object" || C === null)
          S[k] = C;
        else if (C.constructor !== Object && (n = g.get(C.constructor)))
          S[k] = n(C, u);
    ...
    function s(c) {
      ...
      if (c.constructor !== Object && (n = g.get(c.constructor)))
        return n(c, s);
      const u = {};
      i.push(c), o.push(u);
      for (const d in c) {
        ...
        if (typeof S != "object" || S === null)
          u[d] = S;
        else if (S.constructor !== Object && (n = g.get(S.constructor)))
          u[d] = n(S, s);
...
var ol = typeof globalThis == "object" && globalThis && globalThis.Object === Object && globalThis, ll = typeof self == "object" && self && self.Object === Object && self, xe = ol || ll || Function("return this")(), V = xe.Symbol, ga = Object.prototype, il = ga.hasOwnProperty, sl = ga.toString, Q = V ? V.toStringTag : void 0;
function gl(e) {
  var a = il.call(e, Q), r = e[Q];
  try {
    e[Q] = void 0;
    var t = !0;
  } catch {
...
var dl = Object.prototype, cl = dl.toString;
function ul(e) {
  return cl.call(e);
}
var hl = "[object Null]", ml = "[object Undefined]", je = V ? V.toStringTag : void 0;
function da(e) {
  return e == null ? e === void 0 ? ml : hl : je && je in Object(e) ? gl(e) : ul(e);
}
function ca(e) {
...
function fl(e) {
  return typeof e == "symbol" || ca(e) && da(e) == pl;
}
function yl(e, a) {
...
var Sl = Array.isArray, Fe = V ? V.prototype : void 0, Ve = Fe ? Fe.toString : void 0;
function Re(e) {
  if (typeof e == "string")
    return e;
  if (Sl(e))
...
var bl = /\s/;
function Ol(e) {
  for (var a = e.length; a-- && bl.test(e.charAt(a)); )
    ;
  return a;
}
var vl = /^\s+/;
function wl(e) {
  return e && e.slice(0, Ol(e) + 1).replace(vl, "");
}
function ua(e) {
  var a = typeof e;
...
var Nl = "[object AsyncFunction]", Al = "[object Function]", Cl = "[object GeneratorFunction]", kl = "[object Proxy]";
function ma(e) {
  if (!ua(e))
    return !1;
  var a = da(e);
  return a == Al || a == Cl || a == Nl || a == kl;
}
var me = xe["__core-js_shared__"], Ke = (function() {
...
var xl = Function.prototype, Rl = xl.toString;
function El(e) {
  if (e != null) {
    try {
      return Rl.call(e);
...
var Gl = /[\\^$.*+?()[\]{}|]/g, Il = /^\[object .+?Constructor\]$/, Tl = Function.prototype, Ml = Object.prototype, Hl = Tl.toString, Dl = Ml.hasOwnProperty, Pl = RegExp(
  "^" + Hl.call(Dl).replace(Gl, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function Ll(e) {
  if (!ua(e) || ql(e))
    return !1;
...
var _e = Math.max;
function Xl(e, a, r) {
  return a = _e(a === void 0 ? e.length - 1 : a, 0), function() {
    for (var t = arguments, i = -1, o = _e(t.length - a, 0), g = Array(o); ++i < o; )
      g[i] = t[a + i];
    i = -1;
    for (var n = Array(a + 1); ++i < a; )
      n[i] = t[i];
    return n[a] = r(g), zl(e, this, n);
  };
}
function ei(e, a) {
  return Wl(Xl(e, a, ha), e + "");
}
...
function ri(e) {
  return e != null && ni(e.length) && !ma(e);
}
...
var li = "__lodash_hash_undefined__", ii = Object.prototype, si = ii.hasOwnProperty;
function gi(e) {
  var a = this.__data__;
  if (ee) {
    var r = a[e];
  ...
  return si.call(a, e) ? a[e] : void 0;
}
var di = Object.prototype, ci = di.hasOwnProperty;
function ui(e) {
  var a = this.__data__;
  return ee ? a[e] !== void 0 : ci.call(a, e);
}
var hi = "__lodash_hash_undefined__";
function mi(e, a) {
  var r = this.__data__;
  return this.size += this.has(e) ? 0 : 1, r[e] = ee && a === void 0 ? hi : a, this;
}
function L(e) {
...
var fi = Array.prototype, yi = fi.splice;
function Si(e) {
  var a = this.__data__, r = se(a, e);
  if (r < 0)
    return !1;
  var t = a.length - 1;
  return r == t ? a.pop() : yi.call(a, r, 1), --this.size, !0;
}
function bi(e) {
  var a = this.__data__, r = se(a, e);
...
_.prototype.clear = pi;
_.prototype.delete = Si;
_.prototype.get = bi;
_.prototype.has = Oi;
_.prototype.set = vi;
var wi = Ee(xe, "Map");
...
function ge(e, a) {
  var r = e.__data__;
  return Ai(a) ? r[typeof a == "string" ? "string" : "hash"] : r.map;
}
function Ci(e) {
...
function Gi(e, a, r) {
  var t = e.length;
  return r = r === void 0 ? t : r, !a && r >= t ? e : Ei(e, a, r);
}
var Ii = "\\ud800-\\udfff", Ti = "\\u0300-\\u036f", Mi = "\\ufe20-\\ufe2f", Hi = "\\u20d0-\\u20ff", Di = Ti + Mi + Hi, Pi = "\\ufe0e\\ufe0f", Li = "\\u200d", Ui = RegExp("[" + Li + Ii + Di + Pi + "]");
function zi(e) {
  return Ui.test(e);
}
function Bi(e) {
...
var pa = "\\ud800-\\udfff", $i = "\\u0300-\\u036f", ji = "\\ufe20-\\ufe2f", Fi = "\\u20d0-\\u20ff", Vi = $i + ji + Fi, Ki = "\\ufe0e\\ufe0f", Wi = "[" + pa + "]", Ce = "[" + Vi + "]", ke = "\\ud83c[\\udffb-\\udfff]", _i = "(?:" + Ce + "|" + ke + ")", fa = "[^" + pa + "]", ya = "(?:\\ud83c[\\udde6-\\uddff]){2}", Sa = "[\\ud800-\\udbff][\\udc00-\\udfff]", Ji = "\\u200d", ba = _i + "?", Oa = "[" + Ki + "]?", Yi = "(?:" + Ji + "(?:" + [fa, ya, Sa].join("|") + ")" + Oa + ba + ")*", Zi = Oa + ba + Yi, Qi = "(?:" + [fa + Ce + "?", Ce, ya, Sa, Wi].join("|") + ")", Xi = RegExp(ke + "(?=" + ke + ")|" + Qi + Zi, "g");
function es(e) {
  return e.match(Xi) || [];
}
function Je(e) {
  return zi(e) ? es(e) : Bi(e);
}
...
oe.prototype.add = oe.prototype.push = ns;
oe.prototype.has = rs;
function ts(e, a) {
  return e.has(a);
}
...
var ls = 200;
function is(e, a, r, t) {
  var i = -1, o = Zl, g = !0, n = e.length, m = [], s = a.length;
  if (!n)
    return m;
  a.length >= ls && (o = ts, g = !1, a = new oe(a));
  e:
    for (; ++i < n; ) {
      var f = e[i], c = f;
      if (f = f !== 0 ? f : 0, g && c === c) {
...
function Ye(e, a, r) {
  if (e = Ri(e), e && a === void 0)
    return wl(e);
  if (!e || !(a = Re(a)))
    return e;
  var t = Je(e), i = Je(a), o = gs(t, i), g = ss(t, i) + 1;
  return Gi(t, o, g).join("");
}
var ds = ei(function(e, a) {
  return os(e) ? is(e, a) : [];
}), j = function() {
...
function Ie(e, a) {
  for (var r = {}, t = {}, i = e.split(us), o = !1, g = 0; i.length > g; g++) {
    for (var n = i[g].split(cs), m = 0; m < n.length; m += 2) {
...
var hs = {
  ...
  158: 382,
  159: 376
}, ms = String.fromCodePoint || function(e) {
...
}, ps = W(W({}, K), { all: K.html5 }), fs = {
  scope: "body",
  level: "all"
}, fe = /&(?:#\d+|#[xX][\da-fA-F]+|[0-9a-zA-Z]+);/g, ye = /&(?:#\d+|#[xX][\da-fA-F]+|[0-9a-zA-Z]+)[;=]?/g, Ze = {
  xml: {
    strict: fe,
    attribute: ye,
    body: pe.xml
...
}, ys = W(W({}, Ze), { all: Ze.html5 }), va = String.fromCharCode, Ss = va(65533);
function bs(e, a, r, t) {
  ...
  if (r && o === "=")
    ...
    if (g)
      ...
      i = m >= 1114111 ? Ss : m > 65535 ? ms(m) : va(hs[m] || m);
    }
  }
  return i;
}
function Qe(e, a) {
  var r = a === void 0 ? fs : a, t = r.level, i = t === void 0 ? "all" : t, o = r.scope, g = o === void 0 ? i === "xml" ? "strict" : "body" : o;
  if (!e)
    return "";
  var n = ys[i][g], m = ps[i].entities, s = g === "attribute", f = g === "strict";
  return e.replace(n, function(c) {
    return bs(c, m, s, f);
  });
}
var Os = { strictlyTwoElementsInRangeArrays: !1, progressFn: null };
function le(e, a) {
  ...
  return Array.from(e).sort((n, m) => (r.progressFn && (g += 1, r.progressFn(Math.floor(g * 100 / o))), n[0] === m[0] ? n[1] < m[1] ? -1 : n[1] > m[1] ? 1 : 0 : n[0] < m[0] ? -1 : 1));
}
...
function vs(e, a) {
  ...
  let t;
  if (a) if (r(a)) {
    if (t = { ...Xe, ...a }, t.progressFn && r(t.progressFn) && !Object.keys(t.progressFn).length) t.progressFn = null;
...
function Cs(e, a, r) {
  ...
  let t;
  Array.isArray(a) && Number.isInteger(a[0]) && Number.isInteger(a[1]) ? t = [Array.from(a)] : t = Array.from(a), t.length, t.filter((g) => g).forEach((g, n) => {
    if (!Array.isArray(g)) throw new TypeError(`ranges-apply: [THROW_ID_05] ranges array, second input arg., has ${n}th element not an array: ${JSON.stringify(g, null, 4)}, which is ${typeof g}`);
    if (!Number.isInteger(g[0])) {
      if (!Number.isInteger(+g[0]) || +g[0] < 0) throw new TypeError(`ranges-apply: [THROW_ID_06] ranges array, second input arg. has ${n}th element, array ${JSON.stringify(g, null, 0)}. Its first element is not an integer, string index, but ${typeof g[0]}, equal to: ${JSON.stringify(g[0], null, 4)}.`);
      t[n][0] = +t[n][0];
    }
    if (!Number.isInteger(g[1])) {
      if (!Number.isInteger(+g[1]) || +g[1] < 0) throw new TypeError(`ranges-apply: [THROW_ID_07] ranges array, second input arg. has ${n}th element, array ${JSON.stringify(g, null, 0)}. Its second element is not an integer, string index, but ${typeof g[1]}, equal to: ${JSON.stringify(g[1], null, 4)}.`);
      t[n][1] = +t[n][1];
    }
  });
  let i = vs(t, { progressFn: (g) => {
  } });
  As(i);
  let o = i.length;
  if (o > 0) {
...
`;
    if (!o) return o;
    let f = 0, c = "";
    for (let u = 0, d = o.length; u < d; u++) (o[u] === m || o[u] === s && o[u - 1] !== m) && f++, `\r
`.includes(o[u]) || o[u] === r ? o[u] === r ? c += o[u] : o[u] === m ? f <= g && (c += o[u], o[u + 1] === s && (c += o[u + 1], u++)) : o[u] === s && o?.[u - 1] !== m && f <= g && (c += o[u]) : !o[u + 1] && !f && (c += " ");
    return c;
  }
  if (typeof e == "string" && e.length) {
    ...
    return `${i(g, o, !1)}${e.trim()}${t(i(t(n), o, !0))}`;
  }
  return e;
}
var aa = { mergeType: 1, progressFn: null, joinRangesThatTouchEdges: !0 };
function ks(e, a) {
  function r(s) {
    return !!s && typeof s == "object" && !Array.isArray(s);
  }
  ...
  let t;
  if (a) if (r(a)) {
    if (t = { ...aa, ...a }, t.progressFn && r(t.progressFn) && !Object.keys(t.progressFn).length) t.progressFn = null;
...
${JSON.stringify(a, null, 4)} (type ${typeof a})`);
  ...
  let i = e.filter((s) => Array.isArray(s)).map((s) => [...s]).filter((s) => s[2] !== void 0 || s[0] !== s[1]), o, g, n;
  t.progressFn ? o = le(i, { progressFn: (s) => {
    n = Math.floor(s / 5), n !== g && (g = n, t.progressFn != null && t.progressFn(n));
  } }) : o = le(i);
  let m = o.length - 1;
  for (let s = m; s > 0; s--) t.progressFn && (n = Math.floor((1 - s / m) * 78) + 21, n !== g && n > g && (g = n, t.progressFn(n))), (o[s][0] <= o[s - 1][0] || !t.joinRangesThatTouchEdges && o[s][0] < o[s - 1][1] || t.joinRangesThatTouchEdges && o[s][0] <= o[s - 1][1]) && (o[s - 1][0] = Math.min(o[s][0], o[s - 1][0]), o[s - 1][1] = Math.max(o[s][1], o[s - 1][1]), o[s][2] !== void 0 && (o[s - 1][0] >= o[s][0] || o[s - 1][1] <= o[s][1]) && o[s - 1][2] !== null && (o[s][2] === null && o[s - 1][2] !== null ? o[s - 1][2] = null : o[s - 1][2] != null ? +(t || {})?.mergeType == 2 && o[s - 1][0] === o[s][0] ? o[s - 1][2] = o[s][2] : o[s - 1][2] += o[s][2] : o[s - 1][2] = o[s][2]), o.splice(s, 1), s = o.length);
  return o.length ? o : null;
}
var qs = { limitToBeAddedWhitespace: !1, limitLinebreaksCount: 1, mergeType: 1 }, xs = class {
  constructor(e) {
    let a = { ...qs, ...e };
  ...
  add(e, a, r) {
    ...
    let t = +e, i = +a;
    if (B(t) && B(i)) {
      if (D(r) && !$(r) && !rl(r)) throw new TypeError(`ranges-push/Ranges/add(): [THROW_ID_08] The third argument, the value to add, was given not as string but ${typeof r}, equal to:
${JSON.stringify(r, null, 4)}`);
  ...
  current() {
    return Array.isArray(this.ranges) && this.ranges.length ? (this.ranges = ks(this.ranges, { mergeType: this.opts.mergeType }), this.ranges && this.opts.limitToBeAddedWhitespace ? this.ranges.map((e) => D(e[2]) ? [e[0], e[1], Se(e[2], this.opts.limitLinebreaksCount)] : e) : this.ranges) : null;
  }
  wipe() {
    this.ranges = [];
  }
...
sa();
var be = " ";
function Rs({ str: e, idx: a = 0, stopAtNewlines: r = !1, stopAtRawNbsp: t = !1 }) {
...
function E(e, a = 0) {
  return Rs({ str: e, idx: a, stopAtNewlines: !1, stopAtRawNbsp: !1 });
}
function Es(e) {
...
var X = /* @__PURE__ */ new Set(["!doctype", "abbr", "address", "area", "article", "aside", "audio", "base", "bdi", "bdo", "blockquote", "body", "br", "button", "canvas", "caption", "cite", "code", "col", "colgroup", "data", "datalist", "dd", "del", "details", "dfn", "dialog", "div", "dl", "doctype", "dt", "em", "embed", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "iframe", "img", "input", "ins", "kbd", "keygen", "label", "legend", "li", "link", "main", "map", "mark", "math", "menu", "menuitem", "meta", "meter", "nav", "noscript", "object", "ol", "optgroup", "option", "output", "param", "picture", "pre", "progress", "rb", "rp", "rt", "rtc", "ruby", "samp", "script", "section", "select", "slot", "small", "source", "span", "strong", "style", "sub", "summary", "sup", "svg", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "title", "tr", "track", "ul", "var", "video", "wbr", "xml"]), Oe = /* @__PURE__ */ new Set(["a", "b", "i", "p", "q", "s", "u"]), ve = /* @__PURE__ */ new Set([".", ",", ";", "!", "?"]), ta = /* @__PURE__ */ new Set([".", ",", "?", ";", ")", "…", '"', "»"]), Is = /* @__PURE__ */ new Set(["a", "abbr", "acronym", "audio", "b", "bdi", "bdo", "big", "button", "canvas", "cite", "code", "data", "datalist", "del", "dfn", "em", "embed", "i", "iframe", "input", "ins", "kbd", "label", "map", "mark", "meter", "noscript", "object", "output", "picture", "progress", "q", "ruby", "s", "samp", "select", "slot", "small", "span", "strong", "sub", "sup", "svg", "template", "textarea", "time", "u", "tt", "var", "video", "wbr"]), oa = { ignoreTags: [], ignoreTagsWithTheirContents: [], onlyStripTags: [], stripTogetherWithTheirContents: ["script", "style", "xml"], skipHtmlDecoding: !1, trimOnlySpaces: !1, stripRecognisedHTMLOnly: !1, dumpLinkHrefsNearby: { enabled: !1, putOnNewLine: !1, wrapHeads: "", wrapTails: "" }, ignoreIndentations: !1, cb: null, reportProgressFunc: null, reportProgressFuncFrom: 0, reportProgressFuncTo: 100 };
function wa(e, a) {
  let r = Date.now(), t = [], i = [], o = [], g = [], n = {};
  function m() {
    n = { attributes: [] };
  }
  m();
...
`) && I(y, l) ? q += " " : q += T;
    ...
    let z = !ta.has(l[p]), He = l[y - 1] !== ">" || !l[b].trim(), De = !['"', "("].includes(l[N - 1]), Aa = ![";", ".", ":", "!"].includes(l[p]);
    if ((z || He && De && Aa) && (He || De) && l[p] !== "!" && (!Is.has(n.name) || typeof b == "number" && b < N || typeof y == "number" && y > w + 1)) {
      let T = q.match(/\n/g);
...
${JSON.stringify(a, null, 4)}`);
  ...
  let h = { ...oa, ...a, dumpLinkHrefsNearby: Object.assign({}, oa.dumpLinkHrefsNearby, a?.dumpLinkHrefsNearby) };
  if (tl(h, "returnRangesOnly")) throw new TypeError("string-strip-html/stripHtml(): [THROW_ID_05] The Optional Options Object's key returnRangesOnly has been removed from the API since v.5 release.");
  ...
  h.ignoreTags = na(h.ignoreTags, "resolvedOpts.ignoreTags"), h.onlyStripTags = na(h.onlyStripTags, "resolvedOpts.onlyStripTags");
  ...
  let v = new xs({ limitToBeAddedWhitespace: !0, limitLinebreaksCount: 2 });
  if (!h.skipHtmlDecoding) for (; e !== Qe(e, { scope: "strict" }); ) e = Qe(e, { scope: "strict" });
  let P = !1, H = !1, ne = 0, Me = 0, x = e.length, Na = Math.floor(x / 2);
  for (let l = 0; l < x; l++) {
    if (h.reportProgressFunc && (x > 1e3 && x < 2e3 ? l === Na && h.reportProgressFunc(Math.floor((h.reportProgressFuncTo - h.reportProgressFuncFrom) / 2)) : x >= 2e3 && (ne = h.reportProgressFuncFrom + Math.floor(l / x * (h.reportProgressFuncTo - h.reportProgressFuncFrom)), ne !== Me && (Me = ne, h.reportProgressFunc(ne)))), Object.keys(n).length > 1 && n.lastClosingBracketAt && n.lastClosingBracketAt < l && e[l] !== " " && C === null && (C = l), !P && e[l] === "%" && e[l - 1] === "{" && e.includes("%}", l + 1)) {
      c = null;
      let p = e.indexOf("%}", l) - 1;
      if (p > l) {
        l = p;
    ...
    if (!P && M(l) && (!n || Object.keys(n).length < 2) && l > 1) {
      for (let p = l; p--; ) if (e[p - 1] === void 0 || M(p)) {
        ...
        if ((y.includes("/>") || y.includes("/ >") || y.includes('="') || y.includes("='")) && e !== `<${Ye(y.trim(), "/>")}>` && [...X].some((N) => Ye(y.trim().split(/\s+/).filter((w) => w.trim()).filter((w, q) => q === 0), "/>").toLowerCase() === N) && wa(`<${y.trim()}>`, h).result === "") {
          (!o.length || o[o.length - 1][0] !== n.lastOpeningBracketAt) && o.push([b, l + 1]), (!g.length || g[g.length - 1][0] !== n.lastOpeningBracketAt) && g.push([b, l + 1]);
    ...
    if (!H && e[l] === "/" && !n.quotes?.value && Number.isInteger(n.lastOpeningBracketAt) && !Number.isInteger(n.lastClosingBracketAt) && (n.slashPresent = l), e[l] === '"' || e[l] === "'") if (!H && n.nameStarts && n?.quotes?.value === e[l]) if (d.valueStarts === void 0) d = {}, delete n.quotes;
    else {
      d.valueEnds = l, d.value = e.slice(d.valueStarts, l), n.attributes.push(d), d = {}, delete n.quotes;
      let p;
    ...
    else !H && !n.quotes && n.nameStarts && (n.quotes = {}, n.quotes.value = e[l], n.quotes.start = l, n.quotes.next = e.indexOf(e[l], l + 1), d.nameStarts && d.nameEnds && d.nameEnds < l && d.nameStarts < l && !d.valueStarts && (d.name = e.slice(d.nameStarts, d.nameEnds)));
    if (n.nameStarts !== void 0 && n.nameEnds === void 0 && (!e[l].trim() || !Es(e[l]))) {
      ...
      if (typeof n.name == "string" && n.name.toLowerCase() === "doctype" && (H = !0), I(l)) {
        ...
        (h.stripTogetherWithTheirContents.includes(n.name) || h.stripTogetherWithTheirContents.includes("*")) && (g = g.filter(([b, y]) => !(b === n.leftOuterWhitespace && y === l))), h.cb({ tag: n, deleteFrom: n.leftOuterWhitespace, deleteTo: l, insert: `${p}${O}${p}`, rangesArr: v, proposedReturn: [n.leftOuterWhitespace, l, `${p}${O}${p}`] }), ue(), ae(l, h, v);
      }
    }
    if (n.quotes?.start && n.quotes.start < l && !n.quotes.end && d.nameEnds && d.equalsAt && !d.valueStarts && (d.valueStarts = l), !n.quotes && d.nameEnds && e[l] === "=" && !d.valueStarts && !d.equalsAt && (d.equalsAt = l), !n.quotes && d.nameStarts && d.nameEnds && !d.valueStarts && e[l].trim() && e[l] !== "=" && (n.attributes.push(d), d = {}), !n.quotes && d.nameStarts && !d.nameEnds && (H && `'"`.includes(e[d.nameStarts]) ? d.nameStarts < l && e[l] === e[d.nameStarts] && (d.nameEnds = l + 1, d.name = e.slice(d.nameStarts, d.nameEnds)) : e[l].trim() ? e[l] === "=" ? d.equalsAt || (d.nameEnds = l, d.equalsAt = l, d.name = e.slice(d.nameStarts, d.nameEnds)) : e[l] === "/" || M(l) ? (d.nameEnds = l, d.name = e.slice(d.nameStarts, d.nameEnds), n.attributes.push(d), d = {}) : I(l) && (d.nameEnds = l, d.name = e.slice(d.nameStarts, d.nameEnds), n.attributes.push(d), d = {}) : (d.nameEnds = l, d.name = e.slice(d.nameStarts, d.nameEnds))), !n.quotes && n.nameEnds < l && !e[l - 1].trim() && e[l].trim() && !"<>/!".includes(e[l]) && !d.nameStarts && !n.lastClosingBracketAt && (d.nameStarts = l), n.lastOpeningBracketAt !== null && n.lastOpeningBracketAt < l && e[l] === "/" && n.onlyPlausible && (n.onlyPlausible = !1), n.lastOpeningBracketAt !== null && n.lastOpeningBracketAt < l && e[l] !== "/" && (n.onlyPlausible === void 0 && ((!e[l].trim() || I(l)) && !n.slashPresent ? n.onlyPlausible = !0 : n.onlyPlausible = !1), e[l].trim() && n.nameStarts === void 0 && !I(l) && e[l] !== "/" && !M(l) && e[l] !== "!" && (n.nameStarts = l, n.nameContainsLetters = !1)), n.nameStarts && !n.quotes && typeof e[l] == "string" && e[l].toLowerCase() !== e[l].toUpperCase() && (n.nameContainsLetters = !0), M(l) && (ra(n, e, l) || n.quotes.value && typeof n.lastOpeningBracketAt == "number" && Gs(n.quotes.value, e.slice(n.lastOpeningBracketAt, l)) % 2 === 1 && !e.slice(n.lastOpeningBracketAt + 1, l).includes("<") && !e.slice(n.lastOpeningBracketAt + 1, l).includes(">")) && n.lastOpeningBracketAt !== void 0 && (n.lastClosingBracketAt = l, C = null, Object.keys(d).length && (n.attributes.push(d), d = {}), h.dumpLinkHrefsNearby?.enabled && S.tagName && !S.openingTagEnds && (S.openingTagEnds = l)), (!H || e[l] === ">") && n.lastOpeningBracketAt !== void 0) {
      if (n.lastClosingBracketAt === void 0) {
        if (n.lastOpeningBracketAt < l && !I(l) && (e[l + 1] === void 0 || I(l + 1) && !n?.quotes?.value) && n.nameContainsLetters && typeof n.nameStarts == "number") {
          ...
          if (!g.length || g[g.length - 1][0] !== n.lastOpeningBracketAt && g[g.length - 1][1] !== l + 1) if (h.stripTogetherWithTheirContents.includes(n.name) || h.stripTogetherWithTheirContents.includes("*")) {
            let p;
            for (let b = t.length; b--; ) t[b].name === n.name && (p = t[b]);
            p ? (g = g.filter(([b]) => b !== p.lastOpeningBracketAt), g.push([p.lastOpeningBracketAt, l + 1])) : g.push([n.lastOpeningBracketAt, l + 1]);
          } else g.push([n.lastOpeningBracketAt, l + 1]);
        }
...
`.includes(e[l])) {
        ...
        if (!G || h.stripRecognisedHTMLOnly && typeof n.name == "string" && !X.has(n.name.toLowerCase()) && !Oe.has(n.name.toLowerCase()) || !Te && (b || y) || Te && !h.onlyStripTags.includes(n.name) || h.ignoreTagsWithTheirContents.includes(n.name)) {
          ...
          h.cb({ tag: n, deleteFrom: null, deleteTo: null, insert: null, rangesArr: v, proposedReturn: null }), n = {}, d = {};
          ...
          (!g.length || g[g.length - 1][0] !== n.lastOpeningBracketAt) && g.push([n.lastOpeningBracketAt, n.lastClosingBracketAt + 1]);
...
`) ? q += z - l : (!z || z > l) && q++;
    ...
    if ((!P || e[l] === "<" && E(e, E(e, l)) && e[E(e, l)] === "/" && e.startsWith("script", E(e, E(e, l)))) && I(l) && !I(l - 1) && !`'"`.includes(e[l + 1]) && (!`'"`.includes(e[l + 2]) || /\w/.test(e[l + 1])) && !(e[l + 1] === "c" && e[l + 2] === ":") && !(e[l + 1] === "f" && e[l + 2] === "m" && e[l + 3] === "t" && e[l + 4] === ":") && !(e[l + 1] === "s" && e[l + 2] === "q" && e[l + 3] === "l" && e[l + 4] === ":") && !(e[l + 1] === "x" && e[l + 2] === ":") && !(e[l + 1] === "f" && e[l + 2] === "n" && e[l + 3] === ":") && ra(n, e, l)) {
      if (M(E(e, l))) continue;
      if (n.nameEnds && n.nameEnds < l && !n.lastClosingBracketAt && (n.onlyPlausible === !0 && n.attributes?.length || n.onlyPlausible === !1)) {
        let p = U(e, l, n.leftOuterWhitespace, l, n.lastOpeningBracketAt, l);
        h.cb({ tag: n, deleteFrom: n.leftOuterWhitespace, deleteTo: l, insert: p, rangesArr: v, proposedReturn: [n.leftOuterWhitespace, l, p] }), ae(l, h, v), n = {}, d = {};
      }
      if (n.lastOpeningBracketAt !== void 0 && n.onlyPlausible && n.name && !n.quotes && (n.lastOpeningBracketAt = void 0, n.name = void 0, n.onlyPlausible = !1), (n.lastOpeningBracketAt === void 0 || !n.onlyPlausible) && !n.quotes && (n.lastOpeningBracketAt = l, n.slashPresent = !1, n.attributes = [], s === null ? n.leftOuterWhitespace = l : h.trimOnlySpaces && s === 0 ? n.leftOuterWhitespace = f || l : n.leftOuterWhitespace = s, `${e[l + 1]}${e[l + 2]}${e[l + 3]}` == "!--" || `${e[l + 1]}${e[l + 2]}${e[l + 3]}${e[l + 4]}${e[l + 5]}${e[l + 6]}${e[l + 7]}${e[l + 8]}` == "![CDATA[")) {
        ...
        for (let y = l; y < x; y++) if ((!b && p && `${e[y - 2]}${e[y - 1]}${e[y]}` == "]]>" || !p && `${e[y - 2]}${e[y - 1]}${e[y]}` == "-->") && (b = y), b && (b < y && e[y].trim() || e[y + 1] === void 0)) {
          let N = y;
          (e[y + 1] === void 0 && !e[y].trim() || e[y] === ">") && (N += 1), (!o.length || o[o.length - 1][0] !== n.lastOpeningBracketAt) && o.push([n.lastOpeningBracketAt, b + 1]), (!g.length || g[g.length - 1][0] !== n.lastOpeningBracketAt) && g.push([n.lastOpeningBracketAt, b + 1]);
          let w = U(e, y, n.leftOuterWhitespace, N, n.lastOpeningBracketAt, b);
          h.cb({ tag: n, deleteFrom: n.leftOuterWhitespace, deleteTo: N, insert: w, rangesArr: v, proposedReturn: [n.leftOuterWhitespace, N, w] }), l = y - 1, e[y] === ">" && (l = y), n = {}, d = {};
          break;
        }
      }
    }
...
` || e[l] === "\r") && (c = l, u && (u = !1))) : (s !== null && (!n.quotes && d.equalsAt > s - 1 && d.nameEnds && d.equalsAt > d.nameEnds && e[l] !== '"' && e[l] !== "'" && (Ae(d) && n.attributes.push(d), d = {}, n.equalsSpottedAt = void 0), s = null), u || (u = !0, G && !P && typeof c == "number" && l && c < l - 1 && (e.slice(c + 1, l).trim() ? c = null : h.ignoreIndentations || v.push([c + 1, l])))), e[l] === " " ? f === null && (f = l) : f !== null && (f = null), n.name === "script" && (P = !n.slashPresent);
  }
  ...
  return { log: { timeTakenInMilliseconds: Date.now() - r }, result: Cs(e, v.current()), ranges: v.current(), allTagLocations: o, filteredTagLocations: g };
}
class qe {
  speechSynthesis;
  speechSynthesisUtterance;
  ...
  patches;
  constructor() {
    if (this.features = Qo(), this.patches = Xo(), !this.features.speechSynthesis || !this.features.speechSynthesisUtterance)
      throw new Error("Web Speech API is not available in this environment");
  ...
  async initialize(a = {}) {
    ...
    try {
      return this.voiceManager = await A.initialize(r, t), this.voices = this.voiceManager.getVoices(), this.defaultVoice = this.voiceManager.getDefaultVoice(navigator.languages[0] || "en", this.voices), this.initialized = !0, !0;
    } catch (o) {
  ...
  escapeSSML(a) {
    return a.map((r) => ({
      ...r,
      text: r.ssml ? wa(r.text).result : r.text
    }));
  }
  // Queue Management
  loadUtterances(a) {
  ...
  speakCurrentUtterance() {
    ...
    this.validateText(r);
    const t = this.createUtterance(r), i = this.getCurrentVoiceForUtterance(this.currentVoice);
...
export {
  ...
  Ms as WebSpeechEngineProvider,
  Hs as WebSpeechReadAloudNavigator,
  A as WebSpeechVoiceManager,
  te as chineseVariantMap,
  Ts as getAvailableLanguages,
  Le as getTestUtterance,
  Pe as getVoices
};
