...
| `list` | `list-aria-posinset-setsize`, `list-epub-type`, `list-html-native`, `list-item-value-override`, `list-ordered-html-native`, `list-ordered-reversed`, `list-ordered-start`, `list-role-aria` |
| `loa` | `loa-epub-type` |
| `loi` | `loi-epub-type` |
| `lot` | `lot-epub-type` |
| `lov` | `lov-epub-type` |
