...
| `article` | `article-html-native` |
| `aside` | `aside-html-native` |
| `audio` | `audio-html-native` |
...
| `blockquote` | `blockquote-html-native` |
...
| `image` | `image-alt-html-native`, `image-role-aria` |
...
| `table` | `table-html-native`, `table-role-aria` |
