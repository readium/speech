...
[Another demo](https://readium.org/speech/demo/navigator/) of the experimental Navigator is available.

It demonstrates the following features: 

- fetching a list of voices for English
- providing playback controls
- synchronizing the state of the navigator using Speech Synthesis
- highlighting the current utterance
- highlighting the current word boundaries

Note: this demo is experimental and is not intended to be used as a production-ready component, it will change in the foreseeable future, and support for other TTS services will be added.
