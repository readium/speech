...
const veryLowQuality = {
  "voices": [
    {
      "name": "Eddy",
      "localizedName": "apple",
      "note": "Eloquence voices are preloaded by default on Apple devices.",
      "language": "en-US",
      "otherLanguages": [
        "en-GB",
        "de-DE",
    ...
    {
      "name": "eSpeak Arabic",
      "note": "eSpeak voices are preloaded by default on Chrome OS.",
      "language": "ar",
      "os": [
        "ChromeOS"
      ],
